...
function init() {
  ...
  function drawText() { 
    ...
    ctx.font = `${fontSize}px "Nosferatu", "Blood", "Impact", sans-serif`; // Вампирский шрифт
    ctx.fillStyle = "violet"; // Фиолетовый цвет
    ctx.textAlign = "center";
    ctx.fillText("Karoni, Would you be my Valentine?", width / 2, height / 2 + (mobile ? 100 : 200));
}
